...
const STEP1 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663286960690/BaPS45vqLYYkA5NeGbT5G8/step1-chat-fixed_5fea5c09.png";
const STEP2 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663286960690/BaPS45vqLYYkA5NeGbT5G8/step2-ai-gVgFjptvsZGJHP4r9FXfnp.webp";
const STEP3 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663286960690/BaPS45vqLYYkA5NeGbT5G8/step3-calendar-EKCKWCM8uwgMt6QHpzC6xZ.webp";
const STEP4 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663286960690/BaPS45vqLYYkA5NeGbT5G8/step4-karte-EDnHKhKn9fQruNKvAy5nsf.webp";
...
const steps = [
  {
    ...
    desc: "LINEで気軽に相談",
    detail:
      "お客様がLINEで問い合わせると、AIが自然な会話で対応。24時間いつでも、あなたの代わりに丁寧にお答えします。",
    image: STEP1,
  },
  {
    num: 2,
    ...
    desc: "AIが内容を自動整理",
    detail:
      "会話の中からお客様のニーズや悩みをAIが自動で把握。大切な情報を見逃しません。",
    image: STEP2,
  },
  {
    num: 3,
    ...
    desc: "カンタン予約リンク",
    detail:
      "最適なタイミングで予約ページへスムーズにご案内。お客様も迷わず予約完了できます。",
    image: STEP3,
  },
  {
    num: 4,
    ...
    desc: "会話内容を自動保存",
    detail:
      "すべての会話と顧客情報がカルテに自動蓄積。次回の対応もスムーズに。",
    image: STEP4,
  },
];
    ...
    >
      <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl border border-sage-light/60 p-6 shadow-sm hover:shadow-md hover:shadow-sage/10 transition-all duration-300 hover:-translate-y-1 h-full">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sage-light/60 border border-sage/20 mb-4">
          <span className="text-xs font-medium text-sage-dark tracking-wider">
            STEP
          </span>
          <span className="text-sm font-bold text-sage-dark font-display">
            {step.num}
          </span>
        </div>
        ...
        >
          {steps.map((item, i) => (
            ...
            >
              ...
              {item.title}
              {i < 3 && (
                <span className="text-sage/30 ml-1 hidden sm:inline">
                  →
                </span>
              )}
            </div>
